...
<div class="container-fluid mb-3">
    ...
    <div class="row px-3">
        ...
        <div class="col-lg-4 card-profile mt-5 h-50">
            <div class="card card-block card-stretch card-height mb-5">
                <div class="card-body">
                    <div class="d-flex align-items-center mb-3 gap-2 flex-column">
                        ...
                        <div class="ml-3 w-100">
                            ...
                            <a href="{{ route('customers.edit', $customer->id) }}" class="btn btn-primary font-size-14 w-100">Edit</a>
                            <a href="{{ route('customers.index') }}" class="btn btn-danger font-size-14 w-100">Back</a>
                        </div>
                    </div>
        ...
        <div class="col-lg-8 card-profile mt-5">
