            ...
            <div class="card card-block">
                <div class="card-header d-flex justify-content-between bg-dark">
                    <div class="iq-header-title">
                        <h4 class="card-title mb-0 fs-4 text-white">Invoice</h4>
                    </div>
                    ...
                    <div class="invoice-btn d-flex gap-2">
                        <form action="{{ route('pos.printInvoice') }}" method="post">
                            ...
                            <button type="submit" class="btn btn-info mr-2 py-1 d-flex align-items-center gap-2"><span class="material-symbols-outlined fx-6">
                                print
                                </span> Print</button>
                        </form>

                        <button type="button" class="btn btn-warning py-1 mr-2 d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#exampleModal"><span class="material-symbols-outlined text-white">
                            add_circle
                            </span> Create</button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
                            <img src="{{ asset('assets/images/logo.png') }}" class="logo-invoice w-10 img-fluid mb-3">
