            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                            ...
                            <form action="{{ route('pos.updateCart', $item->rowId) }}" method="POST">
                                ...
                                <div class="d-flex gap-2" style="height: 30px">
                                    ...
                                    <div class="input-group-append">
                                        <button type="submit" class="btn btn-success border-none p-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="Sumbit"><span class="material-symbols-outlined fs-6">
                                            check_circle
                                            </span></button>
                                    </div>
                                </div>
                        ...
                        <td>{{ $item->subtotal }}</td>
                        <td>
                            <a href="{{ route('pos.deleteCart', $item->rowId) }}" class="btn btn-danger border-none p-1" data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"><span class="material-symbols-outlined text-white fs-6">
                                close
                                </span></a>
                        </td>
                    </tr>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group col-sm-8">
                                    ...
                                    <div class="d-flex gap-1 ms-2">
                                        ...
                                        <a href="{{ route('pos.index') }}" class="input-group-text bg-danger"><span class="material-symbols-outlined text-white">
                                            close
                                            </span></a>
                                    </div>
                                </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('pos.addCart') }}" method="POST"  style="margin-bottom: 5px">
                                            ...
                                            <button type="submit" class="btn btn-primary border-none" data-toggle="tooltip" data-placement="top" title="" data-original-title="Add"><span class="material-symbols-outlined">
                                                add_circle
                                                </span></button>
                                        </form>
                                    </td>
