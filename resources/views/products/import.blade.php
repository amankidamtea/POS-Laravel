                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="custom-file">
                                    <input type="file" class="form-control w-100 @error('upload_file') is-invalid @enderror" id="upload_file" name="upload_file" onchange="showFileName();">
                                    <label class="formFile" for="upload_file" id="label_input">Choose file (.xls / .xlsx)</label>
                                </div>
                                @error('upload_file')
