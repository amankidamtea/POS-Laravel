                    ...
                    @method('put')
                            ...
                            <div class="col-md-12">
                                <div class="profile-img-edit">
                                    <div class="crm-profile-img-edit">
                                        <img class="crm-profile-pic rounded-circle w-10" id="image-preview" src="{{ $product->product_image ? asset('storage/products/'.$product->product_image) : asset('assets/images/product/default.webp') }}" alt="profile-pic">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="w-100">
                                    <label class="form-file" for="product_image">Choose file</label>
                                    <input type="file" class="form-control @error('product_image') is-invalid @enderror" id="image" name="product_image" accept="image/*" onchange="previewImage();">
                                </div>
                                @error('product_image')
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn bg-danger text-white" href="{{ route('products.index') }}">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
