                    ...
                    @method('put')
                            ...
                            <div class="col-md-12">
                                <div class="profile-img-edit">
                                    <div class="crm-profile-img-edit">
                                        <img class="crm-profile-pic rounded-circle w-20" id="image-preview" src="{{ $supplier->photo ? asset('storage/suppliers/'.$supplier->photo) : asset('assets/images/user/1.png') }}" alt="profile-pic">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="input-group mb-4 col-lg-6">
                                <div class="w-100">
                                    <label class="form-label" for="photo">Choose file</label>
                                    <input type="file" class="form-control @error('photo') is-invalid @enderror" id="image" name="photo" accept="image/*" onchange="previewImage();">
                                </div>
                                @error('photo')
                        ...
                        <div class="mt-2">
                            ...
                            <a class="btn bg-danger text-white" href="{{ route('suppliers.index') }}">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
