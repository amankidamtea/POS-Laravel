                ...
                <div class="card-body">
                    <div class="d-flex flex-column align-items-center mb-3">
                        ...
                        <div class="w-100">
                            ...
                            <a href="{{ route('suppliers.edit', $supplier->id) }}" class="btn btn-primary font-size-14 w-100">Edit</a>
                            <a href="{{ route('suppliers.index') }}" class="btn btn-danger font-size-14 w-100">Back</a>
                        </div>
                    </div>
