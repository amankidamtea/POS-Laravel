@extends('auth.component.main')

@section('content')
<main class="main-content  mt-0">
    <section class="min-vh-100 mb-8">
      <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('{{ asset('assets/new/img/curved-images/curved6.jpg') }}');">
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10">
          <div class="col-xl-4 col-lg-5 col-md-7 mx-auto">
            <div class="card z-index-0">
              ...
              <div class="card-body">
                <form role="form text-left" method="POST" action="{{ route('register') }}">@csrf
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="Name" @error('name') is-invalid @enderror name="name" autocomplete="off" value="{{ old('name') }}" required">
                  </div>
                  @error('name')
                  ...
                  @enderror
                  <div class="mb-3">
                    <input type="text" class="form-control" @error('username') is-invalid @enderror" type="text" placeholder="Username" name="username" autocomplete="off" value="{{ old('username') }}"  required>
                  </div>
                  @error('username')
                  <div class="mb-4" style="margin-top: -20px">
                      <div class="text-danger small">{{ $message }}</div>
                  ...
                  @enderror
                  <div class="mb-3">
                    <input type="email" class="form-control" @error('email') is-invalid @enderror" type="Email" placeholder="Email" name="email" autocomplete="off" value="{{ old('email') }}" required">
                  </div>
                  @error('email')
                  <div class="mb-4" style="margin-top: -20px">
                      <div class="text-danger small">{{ $message }}</div>
                  ...
                  @enderror
                  <div class="mb-3">
                    <input type="password" class="form-control" @error('password') is-invalid @enderror" type="password" placeholder="Password"  name="password" autocomplete="off" required>
                  </div>
                  @error('password')
                  <div class="mb-4" style="margin-top: -20px">
                      <div class="text-danger small">{{ $message }}</div>
                  ...
                  @enderror
                  <div class="mb-3">
                    <input type="password" class="form-control" type="password" placeholder="Passwor Confirmation" name="password_confirmation" autocomplete="off" required>
                  </div>
